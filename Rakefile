...
desc 'Generate documentation for the campaign_manager extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'CampaignManagerExtension'
...
desc 'Test the campaign_manager extension.'
...
namespace :test do
  desc 'Functional test the campaign_manager extension.'
  ...
  desc 'Unit test the campaign_manager extension.'
